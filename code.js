...
window.onload = function() {
  ...
  window.xp_popup("Windows", "<img src='/resources/warning.png' class='alertPromptImg' />If you experience any graphical issues, please try reloading the page. If that doesn't resolve the issue please describe the issue in the Chattable app. Thanks!<br/><br/>While I have you, do you want to go fullscreen for the full experience?", {
    "Yes" : function(){
